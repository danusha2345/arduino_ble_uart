...
## Возможные причины
1. **На ESP32-C6 запущена старая прошивка** (код в репозитории правильный)
2. **Телефон закэшировал старую GATT таблицу** (даже если прошивка правильная!)

**⚠️ ВАЖНО:** Даже если вы прошили правильную версию, телефон может показывать старые данные из кэша!

📖 **См. подробную инструкцию по очистке кэша:** [BLE_CACHE_CLEAR.md](BLE_CACHE_CLEAR.md)
